...
WidgetYAG::WidgetYAG(QWidget *parent) : QWidget(parent)
{
    initUI();
}

void WidgetYAG::initUI()
{
    ...
    btnCurrent = new QPushButton("Current mapping");
    ...
    labelTurn = new QLabel("Turn on the MO delay");
    lineEditTurn = new QLineEdit("8");
    lineEditTurn->setFixedWidth(100);
    labelMs = new QLabel("ms");

    grpBoxSwitch = new QGroupBox("switch");
    checkBoxEnableThe = new QCheckBox("Enable the first pulse \nsuppression of the simulation");
    lineEditEnableThe = new QLineEdit("20");
    lineEditEnableThe->setFixedWidth(100);
    labelEnableTheUs = new QLabel("us");
    checkBoxOpen = new QCheckBox("Open Q switch when the first \npuls suppression ends");
    checkBoxPulse =new QCheckBox("Pulse width reversal");
    checkBoxEnablePulse = new QCheckBox("Enable pulse width setting");

    grpBoxQ = new QGroupBox("Q pulse width");
    labelMinQ = new QLabel("Min Q pulse");
    lineEditMinQ = new QLineEdit("0");
    lineEditMinQ->setFixedWidth(100);
    labelMinUs = new QLabel("us");
    labelMaxQ = new QLabel("Max Q pulse");
