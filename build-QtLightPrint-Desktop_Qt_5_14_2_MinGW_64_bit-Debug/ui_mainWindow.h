...
""));
        ...
        dock4->setMinimumSize(QSize(42, 40));
        dock4->setMaximumSize(QSize(524287, 524287));
        ...
        dock7->setMinimumSize(QSize(60, 44));
        ...
        draw_polygon = new QPushButton(widget_5);
        draw_polygon->setObjectName(QString::fromUtf8("draw_polygon"));
        draw_polygon->setCheckable(true);
        draw_polygon->setAutoExclusive(true);

        verticalLayout->addWidget(draw_polygon);

        draw_pixmap = new QPushButton(widget_5);
        draw_pixmap->setObjectName(QString::fromUtf8("draw_pixmap"));
        draw_pixmap->setCheckable(true);
        draw_pixmap->setAutoExclusive(true);

        verticalLayout->addWidget(draw_pixmap);
        ...
        dock_file->setMaximumSize(QSize(524287, 30));
        dock_file->setFeatures(QDockWidget::NoDockWidgetFeatures);
        dockWidgetContents_7 = new QWidget();
        dockWidgetContents_7->setObjectName(QString::fromUtf8("dockWidgetContents_7"));
        widget_24 = new QWidget(dockWidgetContents_7);
        widget_24->setObjectName(QString::fromUtf8("widget_24"));
        widget_24->setGeometry(QRect(0, 0, 157, 30));
        widget_24->setMinimumSize(QSize(0, 30));
        widget_24->setMaximumSize(QSize(16777215, 30));
        horizontalLayout_12 = new QHBoxLayout(widget_24);
        ...
        scrollArea_3->setEnabled(true);
        scrollArea_3->setMinimumSize(QSize(0, 30));
        scrollArea_3->setMaximumSize(QSize(16777215, 30));
        scrollArea_3->setWidgetResizable(true);
        scrollAreaWidgetContents_3 = new QWidget();
        scrollAreaWidgetContents_3->setObjectName(QString::fromUtf8("scrollAreaWidgetContents_3"));
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 115, 28));
        scrollArea_3->setWidget(scrollAreaWidgetContents_3);

        horizontalLayout_12->addWidget(scrollArea_3);

        leftmove = new QPushButton(widget_24);
        leftmove->setObjectName(QString::fromUtf8("leftmove"));
        leftmove->setMinimumSize(QSize(20, 30));
        leftmove->setMaximumSize(QSize(20, 30));

        horizontalLayout_12->addWidget(leftmove);

        rightmove = new QPushButton(widget_24);
        rightmove->setObjectName(QString::fromUtf8("rightmove"));
        rightmove->setMinimumSize(QSize(20, 30));
        rightmove->setMaximumSize(QSize(20, 30));

        horizontalLayout_12->addWidget(rightmove);
